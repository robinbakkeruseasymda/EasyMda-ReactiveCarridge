...
public class DartBrowseFormHtml
{
  protected static String nl;
  public static synchronized DartBrowseFormHtml create(String lineSeparator)
  {
    nl = lineSeparator;
    DartBrowseFormHtml result = new DartBrowseFormHtml();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_2 = "/p-grid.html\" >" + NL + "" + NL + "<polymer-element name=\"";
  protected final String TEXT_3 = "-browse\" >" + NL + "  <template>" + NL + "    <p-grid rows=\"{{records}}\" columns=\"{{columns}}\" clickEdit=\"{{clickEdit}}\"></p-grid>" + NL + "  </template>" + NL + "  <script type=\"application/dart\" src=\"";
  protected final String TEXT_4 = "_browse.dart\"></script>" + NL + "</polymer-element> " + NL;
