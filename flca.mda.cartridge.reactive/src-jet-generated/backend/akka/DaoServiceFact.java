...
public class DaoServiceFact
{
  protected static String nl;
  public static synchronized DaoServiceFact create(String lineSeparator)
  {
    nl = lineSeparator;
    DaoServiceFact result = new DaoServiceFact();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_5 = " {" + NL + "  def get() : ";
