...
public class ValidateModel
{
  ...
  public static synchronized ValidateModel create(String lineSeparator)
  {
    nl = lineSeparator;
    ValidateModel result = new ValidateModel();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_2 = NL + "#validation-messages";
