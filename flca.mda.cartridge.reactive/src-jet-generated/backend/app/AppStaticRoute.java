...
public class AppStaticRoute
{
  protected static String nl;
  public static synchronized AppStaticRoute create(String lineSeparator)
  {
    nl = lineSeparator;
    AppStaticRoute result = new AppStaticRoute();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_4 = NL + "import scala.concurrent.ExecutionContext" + NL + "import scala.concurrent.duration._" + NL + "import scala.util.Failure" + NL + "import scala.util.Success" + NL + " ";
