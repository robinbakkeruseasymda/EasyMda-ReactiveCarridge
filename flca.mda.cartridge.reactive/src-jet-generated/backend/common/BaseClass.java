...
public class BaseClass
{
  ...
  public static synchronized BaseClass create(String lineSeparator)
  {
    nl = lineSeparator;
  ...
  protected final String TEXT_2 = NL + " " + NL + "import org.apache.commons.lang3.builder.ToStringBuilder" + NL + " " + NL + "abstract class FetchDepth()" + NL + " " + NL + "abstract class BaseClass() {" + NL + "  override def toString() = {" + NL + "    ToStringBuilder.reflectionToString(this)" + NL + "  }\t" + NL + "}";
