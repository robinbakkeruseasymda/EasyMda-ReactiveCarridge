...
public class Profile
{
  ...
  public static synchronized Profile create(String lineSeparator)
  {
    nl = lineSeparator;
  ...
  protected final String TEXT_2 = NL + " " + NL + "import scala.slick.driver.JdbcProfile" + NL + "" + NL + "trait Profile {" + NL + "  val profile: JdbcProfile" + NL + "}";
