...
public class JsonUtils
{
  ...
  public static synchronized JsonUtils create(String lineSeparator)
  {
    nl = lineSeparator;
  ...
  protected final String TEXT_2 = NL + NL + "import com.fasterxml.jackson.databind.{DeserializationFeature, ObjectMapper}" + NL + "import com.fasterxml.jackson.module.scala.experimental.ScalaObjectMapper" + NL + "import com.fasterxml.jackson.module.scala.DefaultScalaModule" + NL + "" + NL + "object JsonUtils {" + NL + "  val mapper = new ObjectMapper() with ScalaObjectMapper" + NL + "  mapper.registerModule(DefaultScalaModule)" + NL + "  mapper.configure(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES, false)" + NL + "" + NL + "  def toJson(value: Map[Symbol, Any]): String = {" + NL + "    toJson(value map { case (k,v) => k.name -> v})" + NL + "  }" + NL + "" + NL + "  def toJson(value: Any): String = {" + NL + "    mapper.writeValueAsString(value)" + NL + "  }" + NL + "" + NL + "  def toMap[V](json:String)(implicit m: Manifest[V]) = fromJson[Map[String,V]](json)" + NL + "" + NL + "  def fromJson[T](json: String)(implicit m : Manifest[T]): T = {" + NL + "    mapper.readValue[T](json)" + NL + "  }" + NL + "}";
